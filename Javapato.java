...
public class Javapato implements Atraccion {
    ...
    * Nombre: Javapato
    ******
    * Descripción: constructor de la clase Javapato
    ******
    * Inputs:
    * String nombre
    ******
    ...
    * Nombre: visitar
    ******
    * Descripción: aplicacion del metodo abstracto, determina la cantidad de javarales que se obtinene cuando las personas visitan el javapato.
    ******
    * Inputs:
    * List<Persona> lista_personas.
    ******
    * Returns:
    * int, cantidad javarales generados por el javapato.
    *****/
    @Override
    public int visitar(List<Persona> lista_personas) {
        ...
        javalares = (int) (6 * Math.floor(son_granjeros / 2) + 6 * Math.floor(son_cientificos / 4) + 6 * Math.floor(son_herreros / 2));
        return javalares;
    }
